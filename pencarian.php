...
// $nama_prodi = $subkriteria6[1];
                ...
                $rr = mysqli_query($conn, "SELECT * from alternatif_kriteria where sub_a_kampus = '$nilai1' AND sub_a_prodi = '$nilai2'  AND sub_spp = '$nilai4' ");
                        ...
                        ?>
                                ...
                                <td class="text-center">
                                    ...
                                    <form action="proses.php" method="POST">
                                        ...
                                        <button class="btn btn-success btn-block" type="submit" formtarget="_blank">Hasil
                                            Perhitungan</button>
                                    </form>
                                </td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-group row">
                                <label for="staticEmail" class="col-sm-4 col-form-label text-left">Akreditasi Kampus</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label for="staticEmail" class="col-sm-4 col-form-label text-left">Akreditasi Prodi</label>
                                <div class="col-sm-8">
                                    <input type="text" readonly class="form-control-plaintext" id="staticEmail"
                                        value=": <?= $namasub2;?>">
                                </div>
                            ...
                            <div class="form-group row">
                                <label for="staticEmail" class="col-sm-4 col-form-label text-left">Asal Jurusan SLTA</label>
                                <div class="col-sm-8">
                                    <input type="text" readonly class="form-control-plaintext" id="staticEmail"
                                        value=": <?= $namasub3;?>">
                                </div>
