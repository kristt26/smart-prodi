...
$value['kampus'] = "((".$value['sub_a_kampus'] . "-". $b1.")/(".$ab1."))*".$normalKampus;
$value['sub_a_prodi'] = (($value['sub_a_prodi']-$b2)/($ab2))*$normalProdi;
$value['prodi'] = "((".$value['sub_a_prodi'] . "-". $b2.")/(".$ab2."))*".$normalProdi;
$value['sub_asal_jurusan'] = (($value['sub_asal_jurusan']-$b3)/($ab3))*$normalAsalJurusan;
$value['jurusan'] = "((".$value['sub_asal_jurusan'] . "-". $b3.")/(".$ab3."))*".$normalAsalJurusan;
$value['sub_spp'] = (($value['sub_spp']-$b4)/($ab4))*$normalSpp;
$value['sppp'] = "((".$value['sub_spp'] . "-". $b4.")/(".$ab4."))*".$normalSpp;
$value['sub_fasilitas'] = (($value['sub_fasilitas']-$b5)/($ab5))*$normalFasilitas;
$value['fasilitass'] = "((".$value['sub_fasilitas'] . "-". $b5.")/(".$ab5."))*".$normalFasilitas;
...
?>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="#" data-toggle='modal'
                                                data-target='#prodi'><?php echo $data['nama_prodi']; ?></a>
                                        </td>
...
?>
                                            ...
                                            <!-- Logout Modal-->
                                            <div class="modal fade" id="universitas<?=$kode?>" tabindex="-1"
                                                role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content bg-warning">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Universitas
                                                                Detail
                                                            </h5>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action="proses.php" method="POST">
                                                ...
                                                <input type="hidden" name="a_kampus"
                                                    value="<?php echo $data['sub_a_kampus']?>">
                                                <input type="hidden" name="a_prodi"
                                                    value="<?php echo $data['sub_a_prodi']?>">
                                                ...
                                                <input type="hidden" name="kd_prodi"
                                                    value="<?php echo $data['kd_prodi']; ?>">
                                                <input type="hidden" name="kd_pts"
                                                    value="<?php echo $data['kd_pts']; ?>">

                                                <input type="hidden" name="hasil"
                                                    value="<?php echo $data['hasil_akhir'];?>">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                echo "<h6>Prodi = ". $data['prodi'] . " = " . $data['sub_a_prodi'] . "</h6>";
                                echo "<h6>Jurusan = ". $data['jurusan'] . " = " . $data['sub_asal_jurusan'] . "</h6>";
                                echo "<h6>SPP = ". $data['sppp'] . " = " . $data['sub_spp'] . "</h6>";
                                echo "<h6>Fasilitas = ". $data['fasilitass'] . " = " . $data['sub_fasilitas'] . "</h6>";
                                echo "<h6>Total = ". $data['hasil_akhir'] . "</h6><br>";
                                ?>
                            </div>
                        </div>
                        <?php endforeach; ?>
