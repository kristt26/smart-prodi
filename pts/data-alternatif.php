      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">ALTERNATIF SUB</li>
          </ol>
          ...
          <div class="card mb-3">
            <div class="card-header">
              DATA ALTERNATIF SUB
              <a href="alternatif.php" class="btn btn-success">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                $sql = mysqli_query($conn, "SELECT * FROM alternatif_kriteria where kd_pts = '$kode' ");
                 ...
                 ?>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="hapus.php?hapus4=<?php echo $data['0']; ?> " onclick="return confirm('Anda yakin untuk Hapus ini  ??')" title="Hapus">
