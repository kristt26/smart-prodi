...
$sql = mysqli_query($conn, "INSERT INTO pts VALUES ('$id','$nama_pts','$alamat','$kota','$kode_pos','$no_telepon','$email','$laman_web','$akreditasi','$username','$password' )");
...
$hit = mysqli_query($conn,"SELECT sum(bobot) AS kode FROM kriteria where kd_pts = '$kd_pts' ");
...
$sql = mysqli_query($conn, "INSERT INTO kriteria VALUES ('$id','$nama_kriteria','$bobot','$kd_pts' )");
...
$sql = mysqli_query($conn, "INSERT INTO subkriteria VALUES ('$id','$kd_kriteria','$nama_sub','$nilai','$kd_pts' )");
