                ...
                <div class="card-body">
                    ...
                    <form action="proses.php" method="POST">
                        ...
                        <div class="form-group row">
                            <label class="col-md-4"><b>Perguruan Tinggi</b></label>
                            <select name='kd_pts' class='form-control col-md-8' required>
                                <option value="">~ Pilih Perguruan Tinggi ~</option>

                                <?php
include 'koneksi.php';

$sql = mysqli_query($conn, "SELECT * FROM pts WHERE kd_pts !='1' ");

while ($prodi = mysqli_fetch_array($sql)) {?>

                                <option value="<?=$prodi['kd_pts']?>">
                                    <?php echo $prodi['nama_pts']; ?></option>
