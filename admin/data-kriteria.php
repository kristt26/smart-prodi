        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              DATA KRITERIA
              <a href="kriteria.php" class="btn btn-success">
                 ...
                 ?>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="hapus.php?hapus2=<?php echo $data['kd_kriteria']; ?> " onclick="return confirm('Anda yakin untuk Hapus ini  ??')" title="Hapus">
