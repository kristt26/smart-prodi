...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2021 at 09:12 AM
...
(5, 'P-S-017', 'D- III Gizi', '0.17460317', '0.02380952', '0.39682539', '-0', '-0', '0.59523809', 'PTS-009');
...
('PTS-006', 'Sekolah Tinggi Ilmu Hukum (STIH) Umel Mandiri Jayapura ', 'Jl.Raya Abepura, Kotaraja Depan Perpustakaan Daerah ', 'Jayapura', '99225', '0967588763', 'stih@umelmandiri.ac.id', 'www.stihumelmandiri.ac.id', 'C', 'stih', 'stih'),
('PTS-007', 'Sekolah Tinggi Ilmu Manajemen dan Ilmu Kumputer (STIMIK) Umel Mandiri Jayapura', 'Jl.Raya Abepura, Kotaraja Depan Perpustakaan Daerah', 'Jayapura', '99225', '09675850967', 'stimik@umelmandiri.ac.id', 'www.stimikumelmandiri', 'C', 'umelmandiri', 'umelmandiri'),
('PTS-008', 'Universitas Muhammadiyah Papua ', 'Jl.Abepura No.25 Tanah Hitam Abepura - Jayapura', 'Jayapura', '99351', '0967586714', 'umpapua@gmail.com', 'umpapua.ac.id', 'C', 'umpapua', 'umpapua'),
('PTS-009', 'Politeknik Kesehatan Jayapura (POLTEKES)', 'Jl.Padang bulan II, Kelurahan Hedam,Distrik Heram ', 'Jayapura', '99225', '0967584280', 'info@poltekesjayapura.ac.id', 'www.poltekesjayapura.ac.id', 'B', 'poltekes', 'poltekes');
...
--
ALTER TABLE `hasil_akhir`
  MODIFY `kd_hasil` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `pencarian`
--
ALTER TABLE `pencarian`
  MODIFY `kd_pencarian` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
